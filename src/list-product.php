...
if (isset($_SESSION['login'])) {
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <li class="nav-item">
        ...
        // Cart navigation link for all users
        echo '
    <li class="nav-item">
                  ...
                  if ($hasil->num_rows > 0) {
                    while ($row = $hasil->fetch_assoc()) { ?>
                      <div class="card mb-3">
                        <div class="row g-0">
                          <div class="col-md-4">
                            <img src="img/<?php echo $row['foto'] ?>" alt="" class="img-fluid rounded-start">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h5 class="card-title"><?php echo $row['nama'] ?></h5>
                              <p class="card-text">
                                Rp <?php echo $row['hrg'] ?><br>
                                Stok : <?php echo $row['jml'] ?><br>
                                <a
                                  href='addCart.php?brg=<?php echo $row['nama'] ?>&hrg=<?php echo $row['hrg'] ?>&jml=1&pjk=<?= $row['pajak'] ?>'>Add
                                  to Cart</a>
                              </p>
                            </div>
                          </div>
  ...
  //session belum ada artiny abelum login
